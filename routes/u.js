...
router.route('/:university')
	.get(function (req, res) {
		...
		// }
		// else {
		dbFunctions.getChatsForUniversity(req.params.university, function(err, result){
...
router.route('/:university/search')
	...
	.post(function (req, res) {
		...
		dbFunctions.getChatsForCourse(domain, subject, courseNumber, function(err, result) {
			if (err) return res.send(err);
			res.render('search', {department: subject, courseNumber : courseNumber})
		})
	});
...
router.route('/:university/add')
	...
	.post(function (req, res) {
		...
		let days = (+(body.saturday === 'saturday')) + 
		...
		dbFunctions.addChat(subject, course, section, startTime, days, roomNumber, building, professor, chatLink, domain, username,
			function(err, result) {
				if (err) return res.send(err);
